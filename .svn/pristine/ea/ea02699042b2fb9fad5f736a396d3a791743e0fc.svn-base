		...
		<div class="widget-body">
			<div class="box_main">
				<form:form id="alxxb" commandName="alxxb" method="post"
					class="form-horizontal no-margin" action="/bpm/alxxb/saveAlxxb"
					...
					<div class="control-group">
						<eazytec:label styleClass="control-label" key="案例名称"><span class="required">*</span></eazytec:label>
						<div class="controls">
							<c:if test="${empty alxxb.id}">
				                <form:input path="name" id="name" class="span12"  required="true"/>
				            </c:if>
					...
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="allx" id="allx"  />
						</div>
					</div>
			 
					<div class="control-group">
						<eazytec:label styleClass="control-label" key="案例内容"/>
							<div class="controls">
								<div id="ckEditor">
						...
						<div class="control-group">
							<c:choose>
                            	<c:when test ="${not empty alxxb.documents}">
				    				<eazytec:label styleClass="control-label" key="documentForm.uploadedFiles"/>
                                </c:when>
                         	</c:choose>
							<div class="controls">
								<c:forEach items="${alxxb.documents}" varStatus="loop" var="document">
									${document.name}
...
<v:javascript formName="alxxbForm" staticJavascript="false"/>
