 ...
 * @author Joram Barrez
 */
public class GetDeploymentResourceEntityCmd implements Command<ResourceEntity>, Serializable {
  
  private static final long serialVersionUID = 1L;
  protected String deploymentId;
  protected String resourceName;
  
  public GetDeploymentResourceEntityCmd(String deploymentId, String resourceName) {
