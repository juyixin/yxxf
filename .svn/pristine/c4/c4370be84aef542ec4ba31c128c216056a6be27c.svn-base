...
public class ProcessDefinitionQueryImpl extends AbstractQuery<ProcessDefinitionQuery, ProcessDefinition> 
  ...
  protected String isSystemDefined;
  ...
  public ProcessDefinitionQuery orderByOrderNo() {
    return orderBy(ProcessDefinitionQueryProperty.ORDER_NO);
  }
  ...
  public ProcessDefinitionQueryImpl startableByUser(String userId) {
	...
	public ProcessDefinitionQuery isSystemDefined(String isSystemDefined) {
