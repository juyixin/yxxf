...
public class TransitionImpl extends ProcessElementImpl implements PvmTransition {
  ...
  public ActivityImpl getParentSource() {
	return parentSource;
}

public void setParentSource(ActivityImpl parentSource) {
	this.parentSource = parentSource;
}



protected ActivityImpl parentSource;
  protected ActivityImpl parentDestination;
