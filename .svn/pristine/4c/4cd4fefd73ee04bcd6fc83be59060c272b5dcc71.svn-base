...
public class ProcessInstanceQueryImpl extends AbstractVariableQueryImpl<ProcessInstanceQuery, ProcessInstance> implements ProcessInstanceQuery, Serializable {
  ...
  public ProcessInstanceQueryImpl processInstanceId(String processInstanceId) {
    if (processInstanceId == null) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.nullProcessInstanceId"));				
    }
  ...
  public ProcessInstanceQuery processInstanceIds(Set<String> processInstanceIds) {
    ...
    if (processInstanceIds.isEmpty()) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.emptyProcessInstanceId"));				
    }
  ...
  public ProcessInstanceQuery processInstanceBusinessKey(String businessKey) {
    if (businessKey == null) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.emptyBusinessKey"));				
    }
  ...
  public ProcessInstanceQuery processInstanceBusinessKey(String businessKey, String processDefinitionKey) {
    if (businessKey == null) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.nullBusinessKey"));				
    }
    this.businessKey = businessKey;
  ...
  public ProcessInstanceQueryImpl processDefinitionId(String processDefinitionId) {
    if (processDefinitionId == null) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.nullprocessDefinitionId"));				
    }
  ...
  public ProcessInstanceQueryImpl processDefinitionKey(String processDefinitionKey) {
    if (processDefinitionKey == null) {
		  throw new ActivitiException(I18nUtil.getMessageProperty("error.nullprocessDefinitionKey"));				
    }
    this.processDefinitionKey = processDefinitionKey;
    return this;
  }
