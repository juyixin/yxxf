...
import com.eazytec.bpm.admin.role.service.impl.RoleServiceImpl;
...
public class UserManagerImplTest extends BaseManagerMockTestCase {
    ...
    public void setUp() throws Exception {
        ...
        //roleManager = new RoleServiceImpl(roleDao);
    }
    ...
    public void testSaveUser() throws Exception {                                           
        ...
        assertTrue(returned.getWorkPhone().equals("303-555-1212"));
