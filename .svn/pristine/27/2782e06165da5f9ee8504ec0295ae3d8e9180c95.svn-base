...
/**
 * Implementation of SimpleFormController that contains convenience methods for
 * subclasses. For example, getting the current user and saving messages/errors.
