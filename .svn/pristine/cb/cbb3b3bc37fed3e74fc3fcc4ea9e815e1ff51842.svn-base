...
public class ExecutionEntityManager extends AbstractManager {
  ...
  @SuppressWarnings("unchecked")
  public List<ExecutionEntity> getAllChildExecutionsByProcessInstanceIds(List<String> processInstanceIds) {
    return getDbSqlSession().selectList("selectAllExecutionsByProcessInstanceIds", processInstanceIds);
  }
