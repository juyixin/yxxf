...
public interface Messages {
  ...
  static final String NODE_TYPE_1_RESOURCES_ERROR = "process.nodetype1.resources.error";
  static final String START_END_EVENT_MANDATORY = "process.startendevent.mandatory";
  static final String PROCESS_NAME_EXISTS = "process.error.sameprocessname";
  ...
  static final String PEOPLE_INVOLVE_POPUP_CAPTION = "task.involve.members";
 // static final String PEOPLE_REMOVE_POPUP_CAPTION = "task.involved.remove";
