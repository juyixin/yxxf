...
import org.activiti.engine.impl.form.FileFormType;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {  
  ...
  protected void initSessionFactories() {
    if (sessionFactories==null) {
      ...
      addSessionFactory(new GenericManagerFactory(TransactorIdentityLinkEntityManager.class));
      ...
      addSessionFactory(new GenericManagerFactory(TableEntityManager.class));
      addSessionFactory(new GenericManagerFactory(CustomOperatingFunctionManager.class));
    }
  ...
  protected void initFormTypes() {
    if (formTypes==null) {
      ...
      formTypes.addFormType(new FileFormType());
