...
//  public List<String> findHistoricProcessInstanceIdsByQueryCriteria(HistoricProcessInstanceQueryImpl historicProcessInstanceQuery, Page page) {
//	    if (getHistoryManager().isHistoryEnabled()) {
//	      return getDbSqlSession().selectList("selectHistoricProcessInstanceIdsByQueryCriteria", historicProcessInstanceQuery, page);
//	    }
//	    return Collections.EMPTY_LIST;
//	  }
  ...
  public HistoricProcessInstanceEntity findHistoricProcessInstanceByInsId(String processInstanceId) {
	    return  (HistoricProcessInstanceEntity) getDbSqlSession().selectOne("selectHistoricProcessInstance", processInstanceId);
  }
  
  public List<HistoricProcessInstanceEntity> getAllProcessInstanceEntitiesByIds(List<String> processInstanceIds) {
	    return  (List<HistoricProcessInstanceEntity>)getDbSqlSession().selectList("selectHistoricProcessInstanceEntitiesByIds", processInstanceIds);
  }
  
  public void updateHistoricProcessInstanceEntity(HistoricProcessInstanceEntity entity) {
	  getDbSqlSession().update(entity);
  }

  @SuppressWarnings("unchecked")
  public List<Map<String,Object>> selectUrgeProcessInstanceResultMap(String taskId){
	  return (List<Map<String,Object>>)getDbSqlSession().selectList("urgeProcessInstanceResultMap",taskId);
  }
