...
public interface GenericDao <T, PK extends Serializable> {
	...
	int findCount(String hql, Object... values);
	
	int findCount(Finder f);

	int findCountByProperty(String property, Object value);

	T findUnique(String hql, Object... values);

	T findUnique(Finder f);

	T findUniqueByProperty(String property, Object value);

	int executeUpdate(String hql, Object... values);

	int executeUpdate(Finder f);
}