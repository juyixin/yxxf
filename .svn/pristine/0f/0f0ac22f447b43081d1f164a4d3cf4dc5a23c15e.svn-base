...
public interface FormService {
  ...
  ProcessInstance submitStartFormData(String processDefinitionId, Map<String, String> properties)throws DataSourceException;
   ...
   */  
  ProcessInstance submitStartFormData(String processDefinitionId, String businessKey, Map<String, String> properties)throws DataSourceException;
  ...
  void submitTaskFormData(String taskId, Map<String, String> properties)throws DataSourceException;
  ...
  ProcessInstance submitStartFormData(String processDefinitionId, Map<String, String> properties,  Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths,boolean isDraft)throws DataSourceException;
  
  Object submitTaskFormData(String taskId, Map<String, String> properties, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths, boolean isStartNodeTask, String proInsId)throws DataSourceException;
  
  ProcessInstance submitStartFormData(String processDefinitionId, String businessKey, Map<String, String> properties, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths)throws DataSourceException;

  void saveTaskFormData(String taskId, Map<String, String> properties, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths,String loggedInUserId, String proInsId)throws DataSourceException;

  ProcessInstance updateStartFormData(String processDefinitionId, String processInstanceId, Map<String, String> properties,  Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths)throws DataSourceException;
  
  Object updateTaskFormData(String taskId, Map<String, String> properties, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths, boolean isSignOff)throws DataSourceException;
  
  List<Map<String,Object>> getFormFieldTraceData(String processInstanceId,String formId) throws DataSourceException;
