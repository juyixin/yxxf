...
public class ResourceEntityManager extends AbstractManager {
  ...
  public void updateResource(ResourceEntity resource) {
	    getDbSqlSession().update(resource);
	  }
  ...
  @SuppressWarnings("unchecked")
  public List<ResourceEntity> findResourcesByDeploymentIds(List<String> deploymentIds) {
	  return getDbSqlSession().selectList("selectResourcesByDeploymentIds",
			  deploymentIds);
	   }
