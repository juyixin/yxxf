...
<div class="row-fluid">
	<div class="span12">
		<div class="widget-body">
			<div>
				<form:form id="vacate" commandName="vacate" method="post"
					class="form-horizontal no-margin" action=""
					autocomplete="off" modelAttribute="vacate"
            ...
            <tr>
				...
				<td height="22" align="left" ></td>
				 ...
				 <tr>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
                    <form:input path="vacateTypeName" id="vacateTypeName"  required="required" readonly="true" style="width:280px;"/>
				 ...
				 <td height="22" style="width:15%" align="right">
					...
					<td height="22" align="left" >
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<form:input path="vacateDay" id="vacateDay"   required="required" readonly="true" style="width:280px;"/>
					<em style="color:red;margin-left:5px">*</em>
					</td>
				</tr>
				...
				<td height="22" align="left" ></td>
				 ...
				 <tr>
					...
					<td height="22" align="left" >
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
                   <form:input path="startTime" id="startTime"  required="required" readonly="true" style="width:280px;"/>
                    <em style="color:red;margin-left:5px">*</em>
					</td>
				 ...
				 <td height="22" style="width:15%" align="right">
					...
					<td height="22" align="left" >
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <form:input path="endTime" id="endTime"  required="required" readonly="true" style="width:280px;"/>
					<em style="color:red;margin-left:5px">*</em>
					</td>
				</tr>
				...
				<tr>
					...
					<td height="22" align="left" >
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
                    <form:textarea path="vacateCause" id="vacateCause"  required="required" readonly="true" style="width:280px;"/>
                    <em style="color:red;margin-left:5px">*</em>
					</td>
