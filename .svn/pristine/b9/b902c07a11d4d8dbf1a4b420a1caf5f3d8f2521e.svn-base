package com.eazytec.vacate.service;
...
public interface VacateService {
	 ...
	 */
      ...
      */
 	PageBean<Vacate> getRecords(PageBean<Vacate> pageBean,String name,String userId,String type);
 	
 	PageBean<Vacate> getRecord(PageBean<Vacate> pageBean,String startTime,String endTime);
