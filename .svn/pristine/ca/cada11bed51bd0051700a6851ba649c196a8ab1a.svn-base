 	...
 	<div class="box_main" style="padding-top: 10px">
		<div class="widget">
			<div class="widget-body">
				<form:form  id="noticeForm" commandName="noticeForm" method="post" action="bpm/admin/saveNoticeForm" autocomplete="off" modelAttribute="noticeForm" enctype="multipart/form-data">
				  	<form:hidden path="id"/>
