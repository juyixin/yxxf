...
if(currentLocation != location.protocol+"//"+window.location.host+"/login" && currentLocation != location.protocol+"//"+window.location.host+"/login?error=true"){
	location.href = location.protocol+"//"+window.location.host+"/login";	
}
    ...
    function refresh() 
    {
        ...
        captchaImage.src= "/captcha/jcaptcha.jpg?uuid="+randomUUID();    
    }
