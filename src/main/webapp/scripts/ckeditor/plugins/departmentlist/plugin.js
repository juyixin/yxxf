...
CKEDITOR.plugins.add( 'departmentlist', {
	init: function( editor ){
		editor.addCommand( 'showDepartmentlistInDialog', new CKEDITOR.dialogCommand( 'departmentlist' ) );
		CKEDITOR.dialog.add( 'departmentlist', function( editor ) {
			var autoAttributes =
			{
				value : 1,
				size : 1,
			...
			return {
				title : form.title.departmentfield,
				minWidth : 350,
				minHeight : 150,
				onShow : function()
				{
				...
				onOk : function()
				{
					...
					if ( isInsertMode ){
						...
						var fakeElement = editor.createFakeElement( element, 'cke_departmentlist', 'text', true );
						...
						elements : [
								{
									type : 'html',
									align : 'left',
									html : '<span class="color-red">*</span><span class="form-title-msg">'+form.msg.departmentlist+'</span>'
								}, 
								{
									id : '_cke_saved_name',
									type : 'text',
							...
							},
							{
								...
								[
									{
									    ...
									    onChange : function() {
									         ...
									         getAllColumnByTableId(element_id, this.getValue(), 'department');
									    },
									    commit : function( element )
										{
									    	//var element = data.element;
									...
									},
									{
										...
										onLoad : function(){
									    	var element_id = '#' + this.getInputElement().$.id;
									    	getAllColumnByTableId(element_id, $("#tableId").val(), 'department');
									    },
									    commit : function( element )
										{
									    	//var element = data.element;
								...
								items :
								[
									[ editor.lang.forms.textfield.typeText, 'departmentlist' ]
								],
								setup : function( element )
								{
