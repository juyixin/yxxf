...
CKEDITOR.plugins.add( 'grouplist', {
	init: function( editor ){
		editor.addCommand( 'showGrouplistInDialog', new CKEDITOR.dialogCommand( 'grouplist' ) );
		CKEDITOR.dialog.add( 'grouplist', function( editor ) {
			var autoAttributes =
			{
				value : 1,
				size : 1,
			...
			return {
				...
				onOk : function()
				{
					...
					if ( isInsertMode ){
						...
						var fakeElement = editor.createFakeElement( element, 'cke_grouplist', 'text', true );
						...
						elements : [
							{
								type : 'html',
								align : 'left',
								html : '<span class="color-red">*</span><span class="form-title-msg">'+form.msg.grouplist+'</span>'
							}, 
							...
							},
							{
								...
								[
									{
									    ...
									    onChange : function() {
									         ...
									         getAllColumnByTableId(element_id, this.getValue(), 'group');
									    },
									    commit : function( element )
										{
									    	//var element = data.element;
									...
									},
									{
										...
										onLoad : function(){
									    	var element_id = '#' + this.getInputElement().$.id;
									    	getAllColumnByTableId(element_id, $("#tableId").val(), 'group');
									    },
									    commit : function( element )
										{
									    	//var element = data.element;
								...
								items :
								[
									[ editor.lang.forms.textfield.typeText, 'grouplist' ]
								],
								setup : function( element )
								{
