...
<script src="<c:url value='/scripts/common.js'/>" type="text/javascript"></script>
	...
	<div class="page-header">
					<img src="/images/listcode.png " style="float:left; margin:9px 6px 5px 5px" /><h2 style="margin:2px;"><fmt:message key="通知公告"/></h2>
				 	<div class="height10"></div>
						<div id="header_links" align="right" style="padding: 2px 0">
		            		<a class="padding3" id="createUser" href="#bpm/admin/addNoticeForm" data-role="button" data-theme="b"    data-icon="">
...
function deleteAllChancesConfirmNotcie(hrjInfoIds){
	    	...
	    	$.msgBox({
	    	    ...
	    	    success: function (result) {
	    	        ...
	    	        if (result == "是") {
	    	        	document.location.href = "#bpm/admin/noticeremove";
