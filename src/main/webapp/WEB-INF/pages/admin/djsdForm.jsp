 	...
 	<div class="box_main" style="padding-top: 10px">
		<div class="widget">
			<div class="widget-body">
				<form:form  id="noticeForm" commandName="noticeForm" method="post" action="bpm/admin/saveNoticeForms" autocomplete="off" modelAttribute="noticeForm" enctype="multipart/form-data">
				  	<form:hidden path="id"/>
					 			...
					 			<div class="control-group">
									...
									<div class="controls">
										<div id="datatype">
										    <div id="datatype">
										    <c:choose>
													<c:when test="${not empty noticeForm.id}">
														
															<form:select path="sffb" items="${dicList}" itemLabel="name" itemValue="name" ></form:select> 
