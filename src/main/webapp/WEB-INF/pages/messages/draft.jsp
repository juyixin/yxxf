 		...
 		if(datarow.length!=0){
 			...
 			$.msgBox({
	    		...
	    		success: function (result) {
	        		if (result == "Yes") {
	        			document.location.href = "#bpm/message/deleteDraft";
...
function _showEditDraft(rowId, tv, rawObject, cm, rdata) {
	return '<a id="editSendM" href="#bpm/message/editMessage" data-role="button" data-theme="b" onclick="_execute(\'target\',\'id='
			+ rawObject[0] + '\');"><b>' + rowId + '</b></a>';
}
</script>
<div class="page-header">
	<div class="pull-left">
		<img src="/images/listcode.png " style="float:left; margin:9px 6px 5px 5px" /><h2><fmt:message key="草稿箱"/></h2>
	</div>
