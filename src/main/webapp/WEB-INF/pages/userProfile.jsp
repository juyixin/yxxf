...
<script type="text/javascript">
   ...
   $(document).ready(function(){
	   ...
	   $( '#dateOfBirth' ).datepicker({
		...
		$('#userGroupsFullName').html($('#userGroupsFullName').val());
						...
						<div id="job">
							<div class="form-horizontal no-margin">
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="employeeNumber" id="employeeNumber"/>
										<span class="control-label" style="text-align:left;">${user.employeeNumber}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="idCardNumber" id="idCardNumber" />
										<span class="control-label" style="text-align:left;">${user.idCardNumber}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
									<form:input type="hidden" path="position" id="position" />
									<span class="control-label" style="text-align:left;">${user.position}</span>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="partTimePosition" id="partTimePosition" />
										<span class="control-label" style="text-align:left;">${user.partTimePosition}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="secretary" id="secretary" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="department" id="department"/>
										<span id="departmentFullName" class="control-label" style="text-align:left;"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="partTimeDepartment" id="partTimeDepartment" />
										<span id="partTimeDepartmentFullName" class="control-label" style="text-align:left;"></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="form-horizontal no-margin">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="userRolesFullName" class="control-label" style="text-align:left;"></span>
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<span id="userGroupsFullName" class="control-label" style="text-align:left;"></span>
									</div>
								</div>
							</div>
						</div>
					 	...
					 	<div id="otherDetails"> 
							<div class="form-horizontal no-margin">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="whereTheWork" id="whereTheWork" />
										<span class="control-label" style="text-align:left;">${whereTheWork}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="comment" id="comment" />
										<span class="control-label" style="text-align:left;">${comment}</span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="hidden" path="resposibilities" id="resposibilities" />
										<span class="control-label" style="text-align:left;">${resposibilities}</span>
									</div>
								</div>
							</div>
							</div>
