...
}if(k){var o=this.facade.getStencilSets();
...
var s=w.findField("namespace").getValue().strip();
s=s.length==0?e.namespace:s;
var x=w.findField("orderNo").getValue().strip();
win.destroy();
this.sendSaveRequest(h,{data:this.serializedDOM,svg:b,title:v,summary:r,type:s,classification_type:u,orderNo:x,designMode:"create"},k,this.mask)
}get .bind(this);
...
var e={title:ORYX.I18N.Save.newProcess,summary:"",type:o.title(),url:h,namespace:o.namespace()};
var l=decodeURIComponent(p[1].split("&")[2].split("=")[1]);
var j=decodeURIComponent(p[1].split("&")[3].split("=")[1]);
var n=decodeURIComponent(p[1].split("&")[4].split("=")[1]).replace("#","");
var m=decodeURIComponent(p[1].split("&")[5].split("=")[1]);
var c=new Ext.Panel({labelAlign:"right",title:ORYX.I18N.Save.dialogDesciption,width:450,bodyStyle:"padding:5px 5px 0 0",items:[{xtype:"form",monitorValid:true,id:"processForm",name:"processForm",layout:"form",border:false,items:[{xtype:"textfield",fieldLabel:ORYX.I18N.Save.dialogLabelName+'<span style="color: rgb(255, 0, 0); padding-left: 2px;">* </span>',name:"title",allowBlank:false,disabled:true,value:l,labelStyle:"font-weight:bold;",regex:/^[A-Za-z\u4e00-\u9eff\.][A-Za-z\' \'\w\u4e00-\u9eff\.][\-a-zA-Z\_\u4e00-\u9eff\s]{1,100}$/,anchor:"90%"},{xtype:"textarea",grow:true,fieldLabel:ORYX.I18N.Save.dialogLabelDesc+" ",name:"summary",value:j,labelStyle:"font-weight:bold;",anchor:"90%"},{xtype:"hidden",grow:true,name:"namespace",value:o.namespace()},{xtype:"textfield",fieldLabel:'排序<span style="color: rgb(255, 0, 0); padding-left: 2px;">* </span>',name:"orderNo",value:m,allowBlank:false,labelStyle:"font-weight:bold;",regex:/^[1-9]{1,2}$/,anchor:"90%"},{xtype:"combo",store:d,id:"classification_type",name:"classification_type",fieldLabel:ORYX.I18N.Save.dialogLabelClassification+'<span style="color: rgb(255, 0, 0); padding-left: 2px;">* </span>',labelStyle:"font-weight:bold;",displayField:"name",valueField:"id",allowBlank:false,typeAhead:true,mode:"local",lazyRender:true,triggerAction:"all",overflow:"auto",emptyText:"请选择流程分类...",editable:false,selectOnFocus:true,anchor:"90%",regex:new RegExp("^[A-Za-z一-黿.][A-Za-z w一-黿.]{1,40}$"),listeners:{expand:function(q){q.setValue(n)
...
var r=v.findField("summary").getValue().strip();
r=r.length==0?e.summary:r;
var q=v.findField("classification_type").getRawValue().strip();
var u=v.findField("classification_type").getValue().strip();
var s=e.namespace;
var w=v.findField("orderNo").getValue().strip();
win.destroy();
this.sendSaveRequest(h,{data:this.serializedDOM,svg:b,title:l,summary:r,type:s,classification_type:u,orderNo:w,designMode:"edit"},k,this.mask)
}get .bind(this);
win=new Ext.Window({id:"Propertie_Window",width:"auto",height:"auto",title:k?ORYX.I18N.Save.saveAsTitle:ORYX.I18N.Save.save,modal:true,bodyStyle:"background:#FFFFFF",items:c,});
win.show()
