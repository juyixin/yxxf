...
@Entity
@Table(name = "YXXF_DJSD")
public class Djsd extends BaseObject{
	...
	private List<NoticeDocument> documents;
	...
	public boolean equals(Object obj) {
		if(obj instanceof Djsd == false) return false;
	...
	@Transient
	public List<NoticeDocument> getDocuments() {
		return documents;
	}

	public void setDocuments(List<NoticeDocument> documents) {
