...
public class BpmnActivityBehavior implements Serializable {
  ...
  protected void performOutgoingBehavior(ActivityExecution execution, 
    ...
    if(execution.isJump() || execution.isReturn()){
    	PvmActivity jumpActivity = execution.getActivity(execution.getJumpActivityId());
    	...
    	if(incomingTransitions != null && incomingTransitions.size() > 0){
    		...
    		if(incomingTransition !=null){
    			transitionsToTake.add(incomingTransition);
        	}
    	}
    }else{
