...
public class GetExecutionVariablesCmd implements Command<Map<String, Object>>, Serializable {
  ...
  public Map<String, Object> execute(CommandContext commandContext) {
    if(executionId == null) {
		throw new ActivitiException(I18nUtil.getMessageProperty("error.executionIdNull"));			
    }
    ...
    if (execution==null) {
		throw new ActivitiException(I18nUtil.getMessageProperty("error.executionIdNotFound"));			
    }
