...
public class HistoricProcessInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricProcessInstanceQuery, HistoricProcessInstance> implements HistoricProcessInstanceQuery {
  ...
  protected String startNodeAssignee; // Adding this field to ensure that creator has completed the start node task.
  ...
  public HistoricProcessInstanceQueryImpl processDefinitionId(String processDefinitionId) {
	  if(processDefinitionIds!=null){
	  		throw new BpmException("Cannot contain both process def id and ids");
	  	}
    this.processDefinitionId = processDefinitionId;
    return this;
  }
  
  public HistoricProcessInstanceQueryImpl processDefinitionIds(List<String> processDefinitionIds) {
  ...
  public HistoricProcessInstanceQuery activated() {
	    this.activated = true;
	    return this;
}
  
  public HistoricProcessInstanceQuery terminated() {
  ...
  public HistoricProcessInstanceQuery startedBy(String userId) {
    ...
    this.startNodeAssignee = userId;
    return this;
  }
  
  public HistoricProcessInstanceQuery processClassification(String classificationId) {
	    this.classificationId = classificationId;
	    return this;
	  }
