...
public class BooleanOperations {
	...
	private static final boolean lt0(TypeConverter converter, Object o1, Object o2) {
		...
		if (t1 == String.class || t2 == String.class) {
			if(Integer.valueOf((String) o1) instanceof Integer) {
				return converter.convert(o1, Integer.class).compareTo(converter.convert(o2, Integer.class)) < 0;
			}
	...
	public static final boolean lt(TypeConverter converter, Object o1, Object o2) {
		...
		if(o1 == "" || o2 == "") { // Assume that we get only Integers
			return false;
		}
	...
	public static final boolean eq(TypeConverter converter, Object o1, Object o2) {
		...
		if (t1 == String.class || t2 == String.class) {
			if(Integer.valueOf((String) o1) instanceof Integer) {
				return converter.convert(o1, Integer.class).equals(converter.convert(o2, Integer.class));
			}
