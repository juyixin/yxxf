...
public class UserQueryProperty implements QueryProperty {
  ...
  public static final UserQueryProperty USER_ID = new UserQueryProperty("RES.ID");
  public static final UserQueryProperty FIRST_NAME = new UserQueryProperty("RES.FIRST_NAME");
  public static final UserQueryProperty LAST_NAME = new UserQueryProperty("RES.LAST_NAME");
  public static final UserQueryProperty EMAIL = new UserQueryProperty("RES.EMAIL");
