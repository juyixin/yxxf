...
public class DefaultStartFormHandler extends DefaultFormHandler implements StartFormHandler {
  ...
  public ExecutionEntity submitStartFormData(ExecutionEntity processInstance, Map<String, String> properties, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths)throws DataSourceException {
    //submitFormProperties(properties, processInstance, subProperties, files, filePaths, false);
