...
public interface FormHandler extends Serializable {
  ...
  void submitFormProperties(Map<String, String> properties, ExecutionEntity execution, Map<String, String[]> subProperties, Map<String, byte[]>files, Map<String, String>filePaths, boolean isUpdate,String taskDefinitionKey)throws DataSourceException;
}
