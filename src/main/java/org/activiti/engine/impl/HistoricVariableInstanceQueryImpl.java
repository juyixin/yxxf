...
public class HistoricVariableInstanceQueryImpl extends AbstractQuery<HistoricVariableInstanceQuery, HistoricVariableInstance> implements
  ...
  public HistoricVariableInstanceQueryImpl processInstanceId(String processInstanceId) {
    ...
    if (processInstanceIds != null) {
        throw new ActivitiException("Cannot provide both process instance id and processinstance ids");
    }
    this.processInstanceId = processInstanceId;
    return this;
  }
  
  public HistoricVariableInstanceQueryImpl processInstanceIds(List<String> processInstanceIds) {
	    if (processInstanceIds == null) {
	      throw new ActivitiException("processInstanceIds is null");
	    }
	    if (processInstanceId != null) {
	        throw new ActivitiException("Cannot provide both process instance id and processinstance ids");
	    }
