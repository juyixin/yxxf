...
public class UserEntityManager extends AbstractManager {
  ...
  public List<Role> findRolesByUser(String userId) {
    ...
    return getDbSqlSession().selectList("selectRolesByUserId", userId);
  }
  
  @SuppressWarnings("unchecked")
  public List<Department> findDepartmentsByUser(String userId) {

    return getDbSqlSession().selectList("selectDepartmentsByUserId", userId);
  }
