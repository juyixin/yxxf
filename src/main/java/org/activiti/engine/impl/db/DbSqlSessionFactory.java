...
public class DbSqlSessionFactory implements SessionFactory {
  ...
  static {
    ...
    addDatabaseSpecificStatement("mysql", "selectHistoricDetailsForInstance", "selectHistoricDetailsForInstance_mysql");
    addDatabaseSpecificStatement("mysql", "getCancelDocumentData", "getCancelDocumentData_mysql");
    ...
    addDatabaseSpecificStatement("oracle", "selectToReadTask", "selectToReadTask_oracle");
    addDatabaseSpecificStatement("oracle", "selectToReadEndTask", "selectToReadEndTask_oracle");
    addDatabaseSpecificStatement("oracle", "selectReadedTask", "selectReadedTask_oracle");
    addDatabaseSpecificStatement("oracle", "selectReadedEndTask", "selectReadedEndTask_oracle");
    addDatabaseSpecificStatement("oracle", "getMyBucketGridData", "getMyBucketGridData_oracle");
    addDatabaseSpecificStatement("oracle", "selectNextTaskForProcessInstance", "selectNextTaskForProcessInstance_oracle");
    addDatabaseSpecificStatement("oracle", "selectPreviousHistoricTaskInstance", "selectPreviousHistoricTaskInstance_oracle");
    addDatabaseSpecificStatement("oracle", "selectHistoricTaskInstanceByTaskDefinitionKey", "selectHistoricTaskInstanceByTaskDefinitionKey_oracle");
    addDatabaseSpecificStatement("oracle", "selectDoneTask", "selectDoneTask_oracle");
    addDatabaseSpecificStatement("oracle", "selectLastCompletedTaskByProcessInstanceId", "selectLastCompletedTaskByProcessInstanceId_oracle");
    addDatabaseSpecificStatement("oracle", "selectPreviousCompletedTasks", "selectPreviousCompletedTasks_oracle");
    addDatabaseSpecificStatement("oracle", "selectNextIdentityLinkByOrder", "selectNextIdentityLinkByOrder_oracle");
    addDatabaseSpecificStatement("oracle", "selectIntegratedTasksForUser", "selectIntegratedTasksForUser_oracle");
    addDatabaseSpecificStatement("oracle", "selectWaitingTasksForMultiSeqSignOff", "selectWaitingTasksForMultiSeqSignOff_oracle");
    addDatabaseSpecificStatement("oracle", "getFormFieldTraceData", "getFormFieldTraceData_oracle");
    addDatabaseSpecificStatement("oracle", "selectPreviousTaskIdByInsId", "selectPreviousTaskIdByInsId_oracle");
    addDatabaseSpecificStatement("oracle", "insertProcessTableValuesSql", "insertProcessTableValuesSql_oracle");
    addDatabaseSpecificStatement("oracle", "insertProcessTableValues", "insertProcessTableValues_oracle");
    addDatabaseSpecificStatement("oracle", "selectNextIdentityLink", "selectNextIdentityLink_oracle");
    addDatabaseSpecificStatement("oracle", "insertSubFormValuesFromMap", "insertSubFormValuesFromMap_oracle");
    addDatabaseSpecificStatement("oracle", "selectHistoricActivityInstance", "selectHistoricActivityInstance_oracle");
    addDatabaseSpecificStatement("oracle", "updateValues", "updateValues_oracle");
    addDatabaseSpecificStatement("oracle", "selectHistoricDetailsForInstance", "selectHistoricDetailsForInstance_oracle");
    addDatabaseSpecificStatement("oracle", "selectHistoricDetailAsMap", "selectHistoricDetailAsMap_oracle");
    addDatabaseSpecificStatement("oracle", "selectBackOffTask", "selectBackOffTask_oracle"); 
    ...
    //added 
    addDatabaseSpecificStatement("mssql", "selectNextTaskForProcessInstance", "selectNextTaskForProcessInstance_mssql");
    addDatabaseSpecificStatement("mssql", "selectNextIdentityLink", "selectNextIdentityLink_mssql");
    addDatabaseSpecificStatement("mssql", "selectNextIdentityLink", "selectNextIdentityLink_mssql");
    
    addDatabaseSpecificStatement("mssql", "selectToReadTask", "selectToReadTask_mssql");
    addDatabaseSpecificStatement("mssql", "selectReadedTask", "selectReadedTask_mssql");
    addDatabaseSpecificStatement("mssql", "selectToReadEndTask", "selectToReadEndTask_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectReadedEndTask", "selectReadedEndTask_mssql"); 
    addDatabaseSpecificStatement("mssql", "getMyBucketGridData", "getMyBucketGridData_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectPreviousCompletedTasks", "selectPreviousCompletedTasks_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectBackOffTask", "selectBackOffTask_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectLastCompletedTaskByProcessInstanceId", "selectLastCompletedTaskByProcessInstanceId_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectPreviousHistoricTaskInstance", "selectPreviousHistoricTaskInstance_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectHistoricActivityInstance", "selectHistoricActivityInstance_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectIntegratedTasksForUser", "selectIntegratedTasksForUser_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectWaitingTasksForMultiSeqSignOff", "selectWaitingTasksForMultiSeqSignOff_mssql"); 
    addDatabaseSpecificStatement("mssql", "selectDoneTask", "selectDoneTask_mssql");
    addDatabaseSpecificStatement("mssql", "selectHistoricTaskInstanceByTaskDefinitionKey", "selectHistoricTaskInstanceByTaskDefinitionKey_mssql");
    addDatabaseSpecificStatement("mssql", "selectNextIdentityLinkByOrder", "selectNextIdentityLinkByOrder_mssql");
    addDatabaseSpecificStatement("mssql", "selectHistoricDetailAsMap", "selectHistoricDetailAsMap_mssql");
