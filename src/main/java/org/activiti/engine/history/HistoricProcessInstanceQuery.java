...
public interface HistoricProcessInstanceQuery extends Query<HistoricProcessInstanceQuery, HistoricProcessInstance> {
  ...
  HistoricProcessInstanceQuery terminated();
  /** Only select historic process instance that are not yet finished. */
  HistoricProcessInstanceQuery unfinished();
  
  /** join historic process instance and execution and select only which is suspended . */
  HistoricProcessInstanceQuery suspended();
  
  /** join historic process instance and execution and select only which is activated . */
  HistoricProcessInstanceQuery activated();
  ...
  /** Only select historic process instances that belong to any of given def ids **/
  HistoricProcessInstanceQueryImpl processDefinitionIds(List<String> processDefinitionIds);
  
  HistoricProcessInstanceQuery processClassification(String classificationId);
}
