...
public interface Task {
  ...
  Map<TaskRole, OperatingFunction> getOperatingFunctions();

	void setOperatingFunctions(
	Map<TaskRole, OperatingFunction> operatingFunctions);
	TaskDefinition getTaskDefinition();
	void setTaskDefinition(TaskDefinition taskDefinition);
	List<IdentityLink> getIdentityLinksApplicableForUser(User user);
	...
	int getFrequenceInterval();
	
	String getUndealOperation();	
	
	Date getLastUrgedTime();
