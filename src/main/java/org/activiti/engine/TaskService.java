...
public interface TaskService {
  ...
  * for better performance.*/
  ...
  /** Return the tasks as key-value pairs list **/
  List<Map<String, Object>> createTaskDescribeQuery(List<Task>tasks);
  
  List<Task> getTasksForUserBySignOffType(User user, List<TransactorType>signOffTypes)throws BpmException;
  
  RtQuery createRtQuery();
  
  Task setTaskDefinition(Task task);
  
  List<IdentityLink> getIdentityLinksForTaskAndUser(String taskId, User user);
  
  void operateOnIdentityLinks(String taskId, String userId, String groupId, String operationType, String identityType, String groupType, List<AgencySetting> agencySettings);
  
  Set<String> operateIdentityLinksByOrder(String taskId, List<Map<String,String>> userDetails, String groupId, String operationType, String identityType, String groupType, List<AgencySetting> agencySettings,String processInstanceId);
  
  List<IdentityLink> getIdentityLinksByUsers(String taskId, List<String>userIds, String type);
  
  List<IdentityLink> getIdentityLinksForTask(String taskId, String type);
  
  TaskEntity getNextTaskForProcessInstance(String processInstanceId)throws BpmException;
 
  void assignSubstitute(List<String> taskIds, String userId);
  
  List<IdentityLink> getIdentityLinksForTaskAndUser(String taskId, User user, List<String> excludeTypes);
  
  List<Map<String,Object>> getHistoricDetailForProcessInstance(String processInstanceId,String formId);
  
  List<Map<String,Object>> getHistoricDetailForInstance(String processInstanceId);
  
  void operateOnIdentityLinks(String taskId, List<String> userIds, String groupId, String operationType, String identityType, String groupType, List<AgencySetting> agencySettings);
  
  void operateOnIdentityLinks(String taskId, String userId, String groupId, String operationType, String identityType, String groupType,int order,List<AgencySetting> agencySettings);
  
  HistoricTaskInstance getPreviousHisTaskIndByInsId(String insId);
  
  List<Map<String, Object>> getUrgeProcessInstanceResultMap(String taskId)throws BpmException;

List<String> getHistoricOrganizers(String taskDefinitionKey);

void operateRtValuesInJavaEvent(Map<String, Object> paramsMap, boolean isUpdate, boolean isDelete);

List<String> getRtValuesInJavaEvent(Map<String, Object> paramsMap);

List<IdentityLink> getIdentityLinksByInstanceId(String processInsId);
}
