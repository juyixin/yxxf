...
public interface ProcessDefinition {
  ...
  /** label manipulated for display purposes */
  ...
  /** Returns true if the process definition is currently active version. */
  boolean isActiveVersion();
  /** Return classificationId for Process definition*/
