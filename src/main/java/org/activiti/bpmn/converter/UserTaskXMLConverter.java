...
public class UserTaskXMLConverter extends BaseBpmnXMLConverter {
  ...
  public UserTaskXMLConverter() {
	StartScriptParser startScriptParser = new StartScriptParser();
    childElementParsers.put(startScriptParser.getElementName(), startScriptParser);  
    ...
    EndScriptParser endScriptParser = new EndScriptParser();
    childElementParsers.put(endScriptParser.getElementName(), endScriptParser); 
  }
  ...
  public class StartScriptParser extends BaseChildElementParser{
	  public String getElementName() {
	      return "startScript";
	    }
	  public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement) throws Exception {
		  String startScript = XMLStreamReaderUtil.moveDown(xtr);
	  }
  }
  
  public class EndScriptParser extends BaseChildElementParser{
	  public String getElementName() {
	      return "endScript";
	    }
	  public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement) throws Exception {
		  String endScript = XMLStreamReaderUtil.moveDown(xtr);
	  }
  }
